...
<div class="container">
    <div class="position-relative overflow-hidden p-3 p-md-3 text-start bg-light text-center">
        <div class="col-md-12 px-3 text-center">
            <h1 class="display-3 fw-normal m-0 p-3">How Content Marketing Can Support Thought Leadership</h1>
        </div>
    </div>
    <div class="position-relative overflow-hidden px-3 pt-0 pb-3 pb-md-3 px-md-3 text-start bg-light">
        <div class="col-md-12 px-lg-3 pb-lg-3 pt-3">
            ...
            <h4 class="mt-4">Content Marketing vs. Thought Leadership</h4>
            <p class="fw-normal">
            ...
            <h4 class="mt-4">The main differences can be seen in the following aspects:</h4>
            <div class="p-2">
                <h6>1. Purpose</h6>
                <p class="fw-normal">
            ...
            <h4 class="mt-4">Understand the differences for more success</h4>
            <p class="fw-normal">
            ...
            <h4 class="mt-4">Where the Two Concepts Intersect: Best Practices</h4>
            <p class="fw-normal">
            ...
            <p class="fw-normal">
                To learn about ELV Agency's executive marketing offerings, <a href="https://www.massivebrand.online/" target="_blank">contact us</a> now.
            </p>
        </div>
    </div>
</div>
